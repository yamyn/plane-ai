  ...
  issues: {
    ...
    layoutOptions: {
      list: {
        ...
        extra_options: {
          access: true,
          values: ["show_empty_groups", "sub_issue", "hide_completed_cycles", "show_estimates_progress"],
        },
      },
      kanban: {
        display_properties: ISSUE_DISPLAY_PROPERTIES_KEYS,
        ...
        extra_options: {
          access: true,
          values: ["show_empty_groups", "show_empty_sub_groups", "sub_issue", "hide_completed_cycles", "show_estimates_progress"],
        },
      },
      calendar: {
